                ...
                <div className="container">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-4 col-md-6 col-sm-10">
                            <div className="blog-post-item-two">
                                <div className="blog-post-thumb-two">
                                    <Link href="blog1"><img src="/assets/img/blog/h2_blog_img01.jpg" alt="" /></Link>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-10">
                            <div className="blog-post-item-two">
                                <div className="blog-post-thumb-two">
                                    <Link href="blog2"><img src="/assets/img/blog/h2_blog_img02.jpg" alt="" /></Link>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-10">
                            <div className="blog-post-item-two">
                                <div className="blog-post-thumb-two">
                                    <Link href="/blog3"><img src="/assets/img/blog/h2_blog_img03.jpg" alt="" /></Link>
