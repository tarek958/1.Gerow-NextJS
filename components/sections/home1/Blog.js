                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-4 col-md-6 col-sm-10">
                            <div className="blog-post-item-two">
                                ...
                                <div className="blog-post-content-two">
                                    <h2 className="title"><Link href="/blog-details">Quand faire appel à un chasseur de tête ?</Link></h2>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-10">
                            <div className="blog-post-item-two">
                                ...
                                <div className="blog-post-content-two">
                                    <h2 className="title"><Link href="/blog-details">Bien recruter : La recette du succès</Link></h2>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-10">
                            <div className="blog-post-item-two">
                                ...
                                <div className="blog-post-content-two">
                                    <h2 className="title"><Link href="/blog-details">Comment décrocher le job de ses rêves !</Link></h2>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-10">
                            <div className="blog-post-item-two">
                                ...
                                <div className="blog-post-content-two">
                                    <h2 className="title"><Link href="/blog-details">Comment choisir le bon cabinet de recrutement ?</Link></h2>
